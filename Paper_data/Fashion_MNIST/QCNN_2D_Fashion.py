...
class QCNN(nn.Module):
    ...
    def __init__(self, I, O, dense_full_gates, dense_reduce_gates, device):
        ...
        self.conv3 = Conv_RBS_density_I2(O // 2, 4, device)
...
torch.save(network_state, "FashionMNIST_2D_modelState")  # save network parameters
